...
export const rtiDetailMockData: Record<string, RTIDetailData> = {
  ...
  'rti-004': {
    ...
    responseAttachments: [
      { id: 'r1', name: 'budget_allocation_2024-25.pdf', type: 'pdf', size: '1.1 MB' },
      { id: 'r2', name: 'district_wise_data.xlsx', type: 'xlsx', size: '378 KB' },
      { id: 'r3', name: 'cost_breakdown_analysis.pdf', type: 'pdf', size: '890 KB' },
      { id: 'r4', name: 'supplier_list.xlsx', type: 'xlsx', size: '245 KB' },
      { id: 'r5', name: 'procurement_guidelines.pdf', type: 'pdf', size: '1.5 MB' },
    ],
  ...
  'rti-005': {
    ...
    responseAttachments: [
      ...
      { id: 'r2', name: 'occupancy_trends_q3_2024.pdf', type: 'pdf', size: '1.4 MB' },
      { id: 'r3', name: 'referral_statistics.pdf', type: 'pdf', size: '780 KB' },
      { id: 'r4', name: 'optimization_measures.pdf', type: 'pdf', size: '1.1 MB' },
    ],
  ...
  'rti-008': {
    ...
    responseAttachments: [
      { id: 'r1', name: 'grant_allocation_list_2024-25.xlsx', type: 'xlsx', size: '412 KB' },
      { id: 'r2', name: 'selection_criteria_guidelines.pdf', type: 'pdf', size: '1.2 MB' },
      { id: 'r3', name: 'evaluation_committee_details.pdf', type: 'pdf', size: '670 KB' },
      { id: 'r4', name: 'utilization_certificates_summary.xlsx', type: 'xlsx', size: '289 KB' },
      { id: 'r5', name: 'monitoring_reports_q1_q2.pdf', type: 'pdf', size: '2.3 MB' },
    ],
  ...
  'rti-009': {
    ...
    responseAttachments: [
      { id: 'r1', name: 'budget_utilization_2024-25.pdf', type: 'pdf', size: '890 KB' },
      { id: 'r2', name: 'zone_wise_pipeline_data.xlsx', type: 'xlsx', size: '234 KB' },
      { id: 'r3', name: 'contractor_list_details.pdf', type: 'pdf', size: '1.1 MB' },
      { id: 'r4', name: 'maintenance_schedule.pdf', type: 'pdf', size: '670 KB' },
      { id: 'r5', name: 'leakage_repair_statistics.xlsx', type: 'xlsx', size: '178 KB' },
      { id: 'r6', name: 'monthly_performance_report.pdf', type: 'pdf', size: '1.5 MB' },
    ],
  ...
  'rti-011': {
    ...
    responseAttachments: [
      { id: 'r1', name: 'outage_area_wise_data.xlsx', type: 'xlsx', size: '345 KB' },
      { id: 'r2', name: 'compensation_claims_list.xlsx', type: 'xlsx', size: '567 KB' },
      { id: 'r3', name: 'disbursement_records.pdf', type: 'pdf', size: '1.2 MB' },
      { id: 'r4', name: 'unscheduled_cut_analysis.pdf', type: 'pdf', size: '1.8 MB' },
      { id: 'r5', name: 'reliability_improvement_plan.pdf', type: 'pdf', size: '2.1 MB' },
    ],
  ...
  'rti-013': {
    ...
    responseAttachments: [
      { id: 'r1', name: 'procurement_plan_2025-26.pdf', type: 'pdf', size: '1.3 MB' },
      { id: 'r2', name: 'budget_allocation_breakdown.xlsx', type: 'xlsx', size: '289 KB' },
      { id: 'r3', name: 'deployment_timeline.pdf', type: 'pdf', size: '890 KB' },
      { id: 'r4', name: 'new_routes_map.pdf', type: 'pdf', size: '2.4 MB' },
      { id: 'r5', name: 'depot_expansion_plan.pdf', type: 'pdf', size: '1.6 MB' },
    ],
    signedBy: 'C. Shikha',
  ...
  'rti-015': {
    ...
    responseAttachments: [
      { id: 'r1', name: 'station_wise_budget.xlsx', type: 'xlsx', size: '312 KB' },
      { id: 'r2', name: 'work_specification_details.pdf', type: 'pdf', size: '1.8 MB' },
      { id: 'r3', name: 'progress_report_jan_2025.pdf', type: 'pdf', size: '1.4 MB' },
      { id: 'r4', name: 'contractor_list_performance.xlsx', type: 'xlsx', size: '234 KB' },
      { id: 'r5', name: 'completion_certificates.pdf', type: 'pdf', size: '2.6 MB' },
      { id: 'r6', name: 'before_after_photos.pdf', type: 'pdf', size: '4.2 MB' },
    ],
