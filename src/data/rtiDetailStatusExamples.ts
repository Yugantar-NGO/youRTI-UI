...
export const rtiStatusExamples: Record<string, RTIDetailData> = {
  ...
  'status-answered': {
    ...
    impactOneLiner: 'Only 60% bed occupancy revealed across 15 Delhi govt hospitals despite public perception of overcrowding',
    impactMetrics: [
      { icon: '🏥', value: '15', label: 'COVERED' },
      { icon: '🛏️', value: '8,450', label: 'BEDS' },
      { icon: '📊', value: '60%', label: 'OCCUPANCY' },
      { icon: '⏱️', value: '14d', label: 'RESPONSE' },
    ],
    impactBadges: ['#HEALTHCARE', '#DATA', '#SURPRISING_STATS', '#TRANSPARENCY'],
    viewCount: 423,
    ...
    responseText: 'With reference to your RTI application dated January 20, 2025, the following information is provided:\n\n1. Bed Capacity: 15 hospitals, 8,450 total beds\n   - General: 6,200 (73%)\n   - ICU: 1,450 (17%)\n   - Isolation: 800 (10%)\n\n2. Occupancy (Oct-Dec 2024):\n   - Average: 60%\n   - General: 58%, ICU: 72%, Isolation: 35%\n   - Peak: 78% in November\n\n3. Referrals: 2,340 patients referred for specialized ICU beds. No general ward denials.\n\n4. Measures: Real-time dashboard, transfer protocol, helpline\n\nHospital-wise data attached.',
    responseAttachments: [
    ...
    keyFindings: [
      ...
      '2,340 patients referred for ICU beds, no general ward denials',
      'Real-time bed tracking now implemented',
    ],

    findingData: [
      { label: 'General', value: 58, total: 100, unit: 'beds' },
      { label: 'ICU/Critical', value: 72, total: 100, unit: 'beds' },
      { label: 'Isolation', value: 35, total: 100, unit: 'beds' },
    ],

    findingContext: 'Data contradicts public perception of overcrowding. Issue is ICU bed distribution, not overall shortage. 2,340 referrals were for specialized ICU beds, suggesting targeted investment needed.',

    extractedEntities: {
      amounts: [
        { value: '8,450', description: 'Total beds' },
        { value: '2,340', description: 'Referrals' },
      ],
      officials: [
        { name: 'Dr. Anjali Sharma', designation: 'Director, Health Services' },
      ],
      dates: [
        { date: 'Oct-Dec 2024', description: 'Reporting period' },
      ],
      locations: [
        { name: 'Delhi', description: '15 hospitals, 8,450 beds' },
      ],
    },
    ...
    timeline: [
      ...
      },
      {
        ...
        description: 'All information provided with 4 documents',
        daysFromFiling: 14,
      },
    ],
  },
