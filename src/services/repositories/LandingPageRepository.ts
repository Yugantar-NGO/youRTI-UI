  ...
  private getTopicStatistics(): TopicStatistics[] {
    return [
      ...
      },
      {
        ...
        responseRate: 34,
        avgResponseDays: 36,
        topDepartment: 'Housing Maharashtra',
        topDepartmentCode: 'Housing MH',
        latestQuestion: 'Affordable housing scheme...',
        latestQuestionLocation: 'Mum',
        latestQuestionAge: '6h ago',
        answeredCount: 234,
        pendingCount: 412,
        overdueCount: 189,
        link: '/browse?topic=housing',
      },
      {
        id: 'topic-007',
        icon: '⚡',
      ...
      },
      {
        ...
        responseRate: 71,
        avgResponseDays: 16,
        topDepartment: 'Police Delhi',
        topDepartmentCode: 'Police DL',
        latestQuestion: 'CCTV installation status...',
        latestQuestionLocation: 'Del',
        latestQuestionAge: '2h ago',
        answeredCount: 379,
        pendingCount: 189,
        overdueCount: 67,
        link: '/browse?topic=police-safety',
      },
      {
        id: 'topic-009',
        icon: '🌳',
      ...
      },
      {
        ...
        responseRate: 52,
        avgResponseDays: 22,
        topDepartment: 'Culture Rajasthan',
        topDepartmentCode: 'Culture RJ',
        latestQuestion: 'Monument restoration funds...',
        latestQuestionLocation: 'Jpr',
        latestQuestionAge: '4h ago',
        answeredCount: 162,
        pendingCount: 112,
        overdueCount: 38,
        link: '/browse?topic=culture-heritage',
      },
    ]
  }
}
