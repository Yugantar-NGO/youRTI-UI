  ...
  private getKeyMetrics(): KeyMetric[] {
    return [
      ...
      },
      {
        id: 'metric-003',
        icon: 'AlertTriangle',
        title: 'RTIs in Appeal',
        value: '427',
        subtitle: '1st + 2nd appeal',
        trend: {
          value: 3,
          direction: 'up',
        },
    ...
    return [
      {
        id: 'insight-001',
        icon: 'TrendingUp',
        text: '62% of RTIs are about local services (roads, water, PDS)',
        category: 'fact',
      },
      {
        id: 'insight-002',
        icon: 'TrendingUp',
        text: 'RTIs on pensions grew 24% vs last year',
        category: 'trend',
      },
      {
        id: 'insight-003',
        icon: 'TrendingDown',
        text: 'Median response time improved by 5 days in 2025',
        category: 'insight',
      },
    ]
  }
